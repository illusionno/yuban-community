<template>
  <div class="sidebar" :class="{ collapse: isMeetWidth }">
    <span class="logo">伴</span>
    <a class="logo-expand" href="#">与伴社区</a>
...
export default defineComponent({
  ...
  setup() {
    ...
    // 监听screenWidth的变化，来控制isMeetWidth(折叠显示)
    watch(screenWidth, () => {
      if (screenWidth.value < 1000) {
        isMeetWidth.value = true;
      } else {
        isMeetWidth.value = false;
      }
    });
    return {
      isMeetWidth,
